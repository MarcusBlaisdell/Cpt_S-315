...
# I split the training data .csv file into an 80% train, 20% test

print("Loading data from file:")


data_train = pd.read_csv("train/train_train.csv")
data_test = pd.read_csv("train/train_test.csv")
print('data loaded')
#print (data_test.head()) # uncomment to verify data looks good

# get labels at target_names
target_names = data_train.author
...
y_train, y_test = data_train.author, data_test.author
